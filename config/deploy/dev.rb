...
set :site_url, %w{test2.gie.byf1.io}
...
set :deploy_to, '/var/www/vhosts/test2.dev'
...
role :app, %w{test2@utility.gie.byf1.io}, :primary => true
role :web, %w{test2@utility.gie.byf1.io}
role :db,  %w{test2@utility.gie.byf1.io}

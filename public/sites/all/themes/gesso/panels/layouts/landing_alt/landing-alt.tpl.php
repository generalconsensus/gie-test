...
<div<?php if (!empty($css_id)): ?> id="<?php print $css_id; ?>"<?php endif; ?> class="l-panels-landing-alt <?php print $classes; ?>">
  ...
  <?php if (!empty($content['title'])): ?>
    <div class="l-title region-landing-title region-landing-title--alt">
